...
fur_dp1=paras.loc[paras['Para_Name']=='fur_dp1']['Value'].tolist()[0]
fur_dp2=paras.loc[paras['Para_Name']=='fur_dp2']['Value'].tolist()[0]
fur_dp3=paras.loc[paras['Para_Name']=='fur_dp3']['Value'].tolist()[0]
...
def Main_Estimate ():
    ...
    # Home Application.
    result_fur=FU.Furniture_C(total_yr,fur_C,fur_dp1,fur_dp2,fur_dp3)
    ...
    for i in range (total_yr):
        ...
        temp.append(round(result_fur[0][i]))
        temp.append(round(result_fur[1][i]))
